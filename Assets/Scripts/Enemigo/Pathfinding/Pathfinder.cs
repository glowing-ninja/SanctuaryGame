...
public class Pathfinder : MonoBehaviour 
{
	...
	// Mio
	public void CrearMapa(Vector2 MapaPosicionInicial, Vector2 MapaPosicionFinal){
		MapStartPosition.x = MapaPosicionInicial.x;
		MapStartPosition.y = MapaPosicionInicial.y;

		MapEndPosition.x = MapaPosicionFinal.x;
		MapEndPosition.y = MapaPosicionFinal.y;
		CreateMap();
	}
    #region map
    //-------------------------------------------------INSTANIATE MAP-----------------------------------------------//
